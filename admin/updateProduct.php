...
<head>
    ...
    <title>Stock - Administration - Ajouter un projet</title>
</head>
<body>
<?php
...
<div class="container-fluid">
    <h1>Modifier le projet: <?= $don['name'] ?></h1>
            ...
            <div class="col-md-6">
                <form action="treatmentUpdateProduct.php?id=<?= $don['id'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="text" id="video_url" name="video_url" class="form-control" value="<?= $don['video_url'] ?>" placeholder="https://www.youtube.com/embed/XXXXX">
                    </div>
                    <div class="form-group my-3">
